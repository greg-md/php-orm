...
trait SelectTableQueryTraitTest
{
    ...
    public function testCanSetSelectColumns()
    {
    ...
    public function testCanThrowExceptionIfNotSelectStrategy()
    {
    ...
    public function testCanCombineClausesWithSelect()
    {
        $query = $this->model()
            ->from('Table2')
            ->inner('Table3')
