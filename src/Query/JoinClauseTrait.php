...
trait JoinClauseTrait
{
    ...
    protected function join($type, $source, $table, $on = null, $param = null, $_ = null)
    {
        ...
        if ($source) {
            ...
            if (($sourceName instanceof SelectQueryInterface) and !$sourceAlias) {
        ...
        if ($tableName instanceof SelectQueryInterface) {
            if (!$tableAlias) {
    ...
    protected function joinToSql($source = null)
    {
        $sql = $params = [];
    ...
    protected function joinToString($source = null)
    {
